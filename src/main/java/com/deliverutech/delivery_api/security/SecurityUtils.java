package com.deliverutech.delivery_api.security;

import com.deliverutech.delivery_api.model.Usuario; // Update this line if 'Usuario' is in 'model' package, or correct to the actual package
